...
$c->swapXY(1);
$c->setPlotArea(100, 45, 650, 700, 0xffffff, -1, 0xffffff, $perlchartdir::Transparent, $perlchartdir::Transparent);
...
Usage: cat file.csv | bar2.pl [-hp] -f outputfile [-t title] [-n topN]");
